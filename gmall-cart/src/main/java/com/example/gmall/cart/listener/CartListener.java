package com.example.gmall.cart.listener;
...
public class CartListener {
    ...
    public void listener(Long spuId) {
        this.pmsClient.querySkusBySpuId(spuId).getData().forEach(skuInfoEntity -> {
            this.redisTemplate.opsForValue().set(PRICE_PREFIX_KEY + skuInfoEntity.getSkuId(), skuInfoEntity.getPrice().toString());
        });
    }


    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "CART-CART-QUEUE", durable = "true"),
