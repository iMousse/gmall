package com.example.gmall.sms.controller;
...
public class SkuBoundsController {
    ...
    public Resp<List<SaleVO>> querySkuSalesBySkuId(@PathVariable("skuId") Long skuId) {
        List<SaleVO> saleVOS = this.skuBoundsService.querySaleBySKuId(skuId);
        return Resp.ok(saleVOS);
    }

    @PostMapping("/sku/sale/save")
    public Resp<Object> saveSales(@RequestBody SkuSaleVO skuSaleVO) {
