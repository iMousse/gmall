...
MySQL - 5.5.28 : Database - guli_ums
*********************************************************************
*/
...
CREATE TABLE `ums_member_level` (
  ...
  `free_freight_point` decimal(10,0) DEFAULT NULL COMMENT '免运费标准',
...
CREATE TABLE `ums_member_statistics_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `member_id` bigint(20) DEFAULT NULL COMMENT '会员id',
  `consume_amount` decimal(10,0) DEFAULT NULL COMMENT '累计消费金额',
  `coupon_amount` decimal(10,0) DEFAULT NULL COMMENT '累计优惠金额',
